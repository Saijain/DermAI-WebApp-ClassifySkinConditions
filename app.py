...
DISEASE_INFO = {
    'Eczema/Atopic Dermatitis': {
        'description': 'Eczema (also called atopic dermatitis) is a condition that causes dry, itchy, and inflamed skin. It\'s a common condition that can affect people of all ages. Atopic dermatitis is a chronic form of eczema that often begins in childhood and causes red, itchy patches on the skin, commonly in skin folds like elbows, knees, and neck.',
        'treatment': [
        ...
        'consult_derm': 'See a dermatologist if your eczema/atopic dermatitis is severe, covers large areas, is infected, or doesn\'t improve with over-the-counter treatments. Consult a dermatologist for proper diagnosis, prescription medications, and a personalized treatment plan. They can help identify and manage triggers.',
        'urgency': 'moderate'
    },
    'Melanoma': {
        ...
        'consult_derm': 'URGENT: If you have a suspicious mole or spot that changes in size, shape, or color, see a dermatologist immediately. Early detection saves lives.',
        'urgency': 'high'
    },
...
def predict_image(image_file, model):
    ...
    try:
        ...
        eczema_atopic_confidence = float((predictions[0][0] + predictions[0][3]) * 100)
        ...
        for i in range(len(CLASS_NAMES)):
            ...
            # Handle combined Eczema/Atopic Dermatitis
            if disease_name == 'Eczema/Atopic Dermatitis':
                if 'Eczema/Atopic Dermatitis' not in seen_diseases:
                    results.append({
                        'disease': 'Eczema/Atopic Dermatitis',
                        'confidence': eczema_atopic_confidence
                    })
                    seen_diseases.add('Eczema/Atopic Dermatitis')
            else:
                results.append({
